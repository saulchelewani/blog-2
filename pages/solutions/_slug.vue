    ...
    <article class='bg-gradient-to-b from-white dark:from-zinc-800 bg-white dark:bg-zinc-800 bg-opacity-70 max-w-4xl mx-auto px-10 py-6 lg:-mt-20 lg:rounded-lg ' v-if='article'>
      ...
      <div class='mt-14 mb-8 flex gap-x-6 md:gap-x-10 font-sans'>
        ...
        <div>
          ...
          <p class='flex mt-4'>
            <a href='https://github.com/saulchelewani' target='_blank' rel='noopener noreferrer' class='px-2'>
              <svg class='text-cyan-500 h-4 mr-4 fill-current' viewBox='0 0 16 16' fill='none'
            ...
            <a href='https://twitter.com/kalmfuz' target='_blank' rel='noopener noreferrer' class='px-2'>
              <svg class='text-cyan-500 h-4 mr-4 fill-current' viewBox='0 0 24 20' fill='none'
                   xmlns='http://www.w3.org/2000/svg'>
                <path
...
.nuxt-content-container h2, .nuxt-content h2 {
  @apply text-lg mt-8 font-bold mb-1;
}
